...
For the full custom-built Godot editor workflow, including manifest fields, replacement, and project selection, see [Custom-Built Godot Editors](/editors/custom-editors).
...
- Official editors are stored in the launcher install folder configured in [settings](/settings).
...
- [Custom-Built Godot Editors](/editors/custom-editors)
- [Godot Launcher Settings](/settings)
