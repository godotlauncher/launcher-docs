...
5. [Configure launcher settings](/getting-started/launcher-settings)

## Common tasks

- [Register a custom-built Godot editor](/guides/custom-editors)
- [Change the editor version for a project](/guides/change-project-editor)
- [Use Git with Godot Launcher](/guides/using-git-with-godot-launcher)
- [Set up Visual Studio Code for Godot](/guides/vscode-setup-for-godot)
