...
<ThemedImage
  className="docs-media-frame"
  alt="Editor version required dialog for a project without saved editor metadata"
  sources={{
...
<ThemedImage
  className="docs-media-frame"
  alt="Editor version required options showing recommended official and custom editor choices"
  sources={{
