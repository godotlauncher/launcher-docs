...
To add a custom-built Godot editor to the selector, see [Custom-Built Godot Editors](/editors/custom-editors).
...
See [Project Settings](/projects/project-settings) for the rename workflow and validation rules.
