...
<ThemedImage
  ...
  sources={{
    light: '/img/screenshots/screen_settings_code_editors_available_light.webp',
    dark: '/img/screenshots/screen_settings_code_editors_available_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/screenshots/screen_settings_code_editors_drawer_overrides_light.webp',
    dark: '/img/screenshots/screen_settings_code_editors_drawer_overrides_dark.webp',
  }}
/>
