...
<details>
<summary>Linux credential storage: Automatic or Secret Service</summary>
...
<ThemedImage
  className="docs-media-frame"
  alt="Expanded Linux credential storage settings showing that secure storage is unavailable"
  sources={{
    light: '/img/screenshots/screen_settings_credential_storage_expanded_unavailable_light.webp',
    dark: '/img/screenshots/screen_settings_credential_storage_expanded_unavailable_dark.webp',
  }}
/>

For unavailable storage, failed saves or launch overrides, see [Linux credential storage troubleshooting](../troubleshooting.md#linux-credential-storage-and-github-connections).
