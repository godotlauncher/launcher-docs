...
If Git is missing, see [Installing Git](/integrations/install-git).
...
See [Visual Studio Code Setup for Godot](/integrations/vscode-setup-for-godot) for the project workflow.
