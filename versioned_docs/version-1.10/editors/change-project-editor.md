...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.10/animations/change-project-editor/change-project-editor-anim_light.gif',
    dark: '/img/docs/1.10/animations/change-project-editor/change-project-editor-anim_dark.gif',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.10/screenshots/screen_projects_new_project_custom_editor_light.webp',
    dark: '/img/docs/1.10/screenshots/screen_projects_new_project_custom_editor_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.10/screenshots/screen_projects_missing_editor_light.webp',
    dark: '/img/docs/1.10/screenshots/screen_projects_missing_editor_dark.webp',
  }}
/>
