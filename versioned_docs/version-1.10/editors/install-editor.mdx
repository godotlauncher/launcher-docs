...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.10/animations/install-editor/launcher-install-editor-ui-anim_light.gif',
    dark: '/img/docs/1.10/animations/install-editor/launcher-install-editor-ui-anim_dark.gif',
  }}
/>
...
For the full custom-built Godot editor workflow, including manifest fields, replacement, and project selection, see [Custom-Built Godot Editors](./custom-editors.mdx).
...
- Official editors are stored in the launcher install folder configured in [settings](../settings/launcher-settings.mdx).
