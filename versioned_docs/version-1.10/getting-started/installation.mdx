...
<img
  ...
  src="/img/docs/1.10/win-installer-ui.webp"
...
3. Select the signature and confirm Windows reports that it is valid.
4. Confirm the signer or certificate details match the release signing information below.
...
<img
  className="docs-media-frame"
  src="/img/docs/1.10/dmg-installer-ui.webp"
