...
<ThemedImage
  ...
  alt="Godot Launcher creating a new project"
  sources={{
    light: '/img/docs/1.10/animations/create-project/create-project-anim_light.gif',
    dark: '/img/docs/1.10/animations/create-project/create-project-anim_dark.gif',
  }}
/>
...
5. Click **Create Project** and, if enabled, **Edit now** to launch it immediately.
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.10/screenshots/screen_projects_new_project_overwrite_path_light.webp',
    dark: '/img/docs/1.10/screenshots/screen_projects_new_project_overwrite_path_dark.webp',
  }}
/>
...
To add a custom-built Godot editor to the selector, see [Custom-Built Godot Editors](../editors/custom-editors.mdx).
...
If you meant to bring an existing project into the launcher, use [Add an Existing Project](./add-existing-project.mdx) instead.
...
See [Project Settings](./project-settings.mdx) for the rename workflow and validation rules.
...
For version-selection rules, missing editor recovery, .NET handling, and integration details, visit [Add an Existing Project](./add-existing-project.mdx).
