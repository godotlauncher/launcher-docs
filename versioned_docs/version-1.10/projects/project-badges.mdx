...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.10/animations/project-badges/project-badges-anim_light.gif',
    dark: '/img/docs/1.10/animations/project-badges/project-badges-anim_dark.gif',
  }}
/>
...
- [Launch Godot Project in Windowed Mode](./launch-godot-project-in-windowed-mode.md)
