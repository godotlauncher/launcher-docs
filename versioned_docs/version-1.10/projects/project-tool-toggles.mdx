...
If VS Code config files cannot be safely read, Godot Launcher preserves timestamped `.bad` copies and recreates the files it needs. See [Visual Studio Code Setup for Godot](../tools/vscode-setup.md#recover-from-invalid-vs-code-config-files) for details.
...
[See Install Git for more info](../tools/install-git.md)
:::
...
- [Using Git With Godot Launcher](../tools/using-git-with-godot-launcher.mdx)
