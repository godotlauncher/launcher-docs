...
>   alt="Godot Launcher - Quick Launch from System Tray UI Windows"
>   sources={{
>     light: '/img/docs/1.10/features/System_Tray_Docs_Light.webp',
>     dark: '/img/docs/1.10/features/System_Tray_Docs_Dark.webp',
>   }}
> />
...
## Godot Launcher Behavior Settings {#launcher-behavior-settings}

> <ThemedImage
>   className="docs-media-frame"
>   alt="Godot Launcher Settings - Behavior Tab"
>   sources={{
...
## Closing and Reopening the Godot Launcher {#closing-and-reopening-the-launcher}
