...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/animations/change-project-editor/change-project-editor-anim_light.gif',
    dark: '/img/docs/1.11/animations/change-project-editor/change-project-editor-anim_dark.gif',
  }}
/>
