...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_installs_custom_editors_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_installs_custom_editors_dark.webp',
  }}
/>
...
For normal projects that use official Godot releases, install an editor from the regular [Installing an Editor](./install-editor.mdx) flow.
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_installs_custom_editor_menu_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_installs_custom_editor_menu_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_installs_custom_editor_drawer_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_installs_custom_editor_drawer_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_installs_custom_manifest_drop_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_installs_custom_manifest_drop_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_installs_custom_manifest_drop_unsupported_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_installs_custom_manifest_drop_unsupported_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_installs_custom_editor_replace_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_installs_custom_editor_replace_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_projects_new_project_custom_editor_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_projects_new_project_custom_editor_dark.webp',
  }}
/>
