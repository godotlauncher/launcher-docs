...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/animations/windows-symlink/windows-symlink-anim_light.gif',
    dark: '/img/docs/1.11/animations/windows-symlink/windows-symlink-anim_dark.gif',
  }}
/>
...
- **UAC prompt appears every time a change in release happens**: Make sure you have enabled `Developer Mode`.
  ...
  <img
    className="docs-media-frame"
    src="/img/docs/1.11/UAC_prompt.webp"
