...
<ThemedImage
  ...
  alt="Projects view with the Add button"
  sources={{
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_projects_drop_overlay_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_projects_drop_overlay_dark.webp',
  }}
/>
