...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_projects_new_project_code_editor_options_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_projects_new_project_code_editor_options_dark.webp',
  }}
/>
