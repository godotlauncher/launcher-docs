...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_installs_catalog_error_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_installs_catalog_error_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_projects_editor_resolution_options_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_projects_editor_resolution_options_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_projects_code_editor_launch_warning_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_projects_code_editor_launch_warning_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.11/screenshots/screen_onboarding_preferences_linux_tray_unavailable_light.webp',
    dark: '/img/docs/1.11/screenshots/screen_onboarding_preferences_linux_tray_unavailable_dark.webp',
  }}
/>
