...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_installs_custom_editors_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_installs_custom_editors_dark.webp',
  }}
/>
...
<ThemedImage
  className="docs-media-frame"
  alt="Custom Editor menu in the Installs view"
  sources={{
    light: '/img/docs/1.12/screenshots/screen_installs_custom_editor_menu_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_installs_custom_editor_menu_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_installs_custom_editor_drawer_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_installs_custom_editor_drawer_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_installs_custom_manifest_drop_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_installs_custom_manifest_drop_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_installs_custom_manifest_drop_unsupported_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_installs_custom_manifest_drop_unsupported_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_installs_custom_editor_replace_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_installs_custom_editor_replace_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_new_project_custom_editor_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_new_project_custom_editor_dark.webp',
  }}
/>
