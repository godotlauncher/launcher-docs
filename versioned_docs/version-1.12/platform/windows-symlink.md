...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/animations/windows-symlink/windows-symlink-anim_light.gif',
    dark: '/img/docs/1.12/animations/windows-symlink/windows-symlink-anim_dark.gif',
  }}
/>
