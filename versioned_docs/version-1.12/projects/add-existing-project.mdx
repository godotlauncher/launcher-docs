...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_drop_overlay_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_drop_overlay_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_editor_resolution_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_editor_resolution_dark.webp',
  }}
/>
