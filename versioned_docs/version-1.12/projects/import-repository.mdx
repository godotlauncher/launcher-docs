...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_add_source_menu_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_add_source_menu_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_clone_public_repository_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_clone_public_repository_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_github_repository_selection_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_github_repository_selection_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_remote_clone_destination_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_remote_clone_destination_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_remote_submodules_detected_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_remote_submodules_detected_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_remote_submodules_cancelled_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_remote_submodules_cancelled_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_remote_submodules_failed_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_remote_submodules_failed_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_remote_project_review_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_remote_project_review_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_remote_editors_required_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_remote_editors_required_dark.webp',
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/img/docs/1.12/screenshots/screen_projects_remote_clone_preserved_light.webp',
    dark: '/img/docs/1.12/screenshots/screen_projects_remote_clone_preserved_dark.webp',
  }}
/>
